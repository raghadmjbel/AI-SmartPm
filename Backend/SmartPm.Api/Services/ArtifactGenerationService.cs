...
namespace SmartPm.Api.Services
{
    public class ArtifactGenerationService : IArtifactGenerationService
    {
        ...
        public class AiServiceException : Exception
        {
            ...
            public AiServiceException(HttpStatusCode statusCode, string message, string responseBody = null, Exception innerException = null)
            ...
            CancellationToken cancellationToken = default) where T : new()
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                {
                    throw new AiServiceException(HttpStatusCode.TooManyRequests,
                        $"AI service failed with 429 Too Many Requests. Body: {errorBody}",
                        errorBody);
                }

                throw new AiServiceException(response.StatusCode,
                    $"AI service failed with {(int)response.StatusCode} {response.ReasonPhrase}. Body: {errorBody}",
                    errorBody);
            }
